...
<table class="form-table editcomment" >
   <tbody>
        <tr>
            <td>
                <h3>
                <img  src="<?php echo bravisthemeuser()->acess_url.'images/facebook.png' ?>" title="Google" alt="Google">
                    Facebook
                </h3>
                ...
                <td>
                    <h3>
                            <label class="wp-neworks-label">
                                <img  src="<?php echo bravisthemeuser()->acess_url.'images/google.png' ?>" title="Google" alt="Google">
                            Google
                            </label>
                    </h3>

...
/**
 * Add Bravis Theme User Widget.
 *
 * @name Bravis Theme User_shortcodes
 * @since 1.0.0
 */
if (! class_exists ( 'Bravis_Theme_User_Widget' )) {
	class Bravis_Theme_User_Widget extends WP_Widget {
		function __construct() {
			parent::__construct ( 'bravisthemeuser_widget', __ ( 'Bravis Theme User', 'ct-user-form' ), array (

 ...
 * add shortcode to VC.
 *
 * @name Bravis Theme User_shortcodes
 * @since 1.0.0
 */
if (! class_exists ( 'Bravis_Theme_User_shortcodes' )) {
	class Bravis_Theme_User_shortcodes {
		...
		function add_shortcodes_params() {
			vc_map ( array (
					"name" => __ ( "Bravis Theme User Forms", 'ct-user-form' ),
					"base" => "ct-user-form",
					'class'    => 'ct-icon-element',
				    'description' => esc_html__( 'User Form Displayed', 'ct-user-form' ),
				    'category' => esc_html__('BravisThemes Shortcodes', 'ct-user-form'),
					"params" => array (
						array(
				            'type' => 'textfield',
	...
	// start.
	new Bravis_Theme_User_shortcodes ();
}

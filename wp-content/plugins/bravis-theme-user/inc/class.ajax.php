...
/**
 * Add Bravis Theme User Core.
 *
 * @name Bravis Theme User_Ajax
 * @since 1.0.0
 */
if (! class_exists('Bravis_Theme_User_Ajax')) {

    class Bravis_Theme_User_Ajax
    {
        ...
        function form_ajax_register_callback() {
            ...
            check_ajax_referer( Bravis_Theme_User::NONCE );
            /* if login data null. */

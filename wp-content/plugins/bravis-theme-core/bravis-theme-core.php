...
define('CT_TEXT_DOMAIN', 'bravis-theme-core');
...
final class Bravis_Theme_Core {
    ...
    const CT_CATEGORY_NAME = 'bravis-theme-core';

    const CT_CATEGORY_TITLE = 'Bravis Theme Core';
    ...
    const CT_TAB_NAME = 'bravis_theme_core';

    const CT_TAB_TITLE = 'Bravis Theme Core';
    ...
    public function enqueue(){
        ...
        wp_enqueue_style('slick-css', CT_URL . 'assets/css/lib/slick.css', [], '1.0.0');
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Bravis Theme Core', CT_TEXT_DOMAIN ) . '</strong>',
    ...
    {
        $plugin_name = '<strong>' . esc_html__("Bravis Theme Core", CT_TEXT_DOMAIN) . '</strong>';
    ...
    public function init_controls() {
        ...
        // Register control
        $controls_manager->register_control( self::EMOJI_CONTROL, new Bravis_Theme_Core_EmojiOneArea_Control() );
        $controls_manager->register_control( self::LAYOUT_CONTROL, new Bravis_Theme_Core_Layout_Control() );
        $controls_manager->register_control( self::ICONS_CONTROL, new Bravis_Theme_Core_Icons_Control() );
        $controls_manager->register_control( self::LIST_CONTROL, new Bravis_Theme_Core_List_Control() );
        $controls_manager->register_control( self::LIST_PRICING_CONTROL, new Bravis_Theme_Core_List_Pricing_Control() );
        $controls_manager->register_control( self::PROGRESSBAR_CONTROL, new Bravis_Theme_Core_Progressbar_Control() );
...
*/
add_filter( 'update_plugins_api.bravisthemes.com', 'pxl_update_plugins_api', 10, 4 );

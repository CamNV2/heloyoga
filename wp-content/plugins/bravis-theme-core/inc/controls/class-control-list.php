 ...
 * @since 1.0.0
 */
class Bravis_Theme_Core_List_Control extends \Elementor\Base_Data_Control {

    /**
     * Get emoji one area control type.
     *
     * Retrieve the control type, in this case `ct_lists`.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function enqueue() {
        ...
        wp_register_script('ct_lists-control', CT_URL . 'assets/lib/iconpicker/ct-iconpicker.js', array('jquery', 'jquery.fonticonpicker.js'), '1.0.0');
        wp_enqueue_script( 'ct_lists-control' );
    }
            ...
            <div class="elementor-control-input-wrapper">
                ...
                <div class="ct-group">
                    <#
                        ...
                        template += '</select></div></div></div></div><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Content', CT_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><input type="text" class="elementor-control-tag-area elementor-input ct-content-input" /></div></div></div></div></div>';
                    #>
                    ...
                    #>
                            <div class="ct-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative;">
                                ...
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Content', CT_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <input type="text" class="elementor-control-tag-area elementor-input ct-content-input" value="{{ content_val }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>

<?php
/**
 * Elementor Bravis icon picker control.
 *
 * @since 1.0.0
 */
class Bravis_Theme_Core_List_Pricing_Control extends \Elementor\Base_Data_Control {

    /**
     * Get emoji one area control type.
     *
     * Retrieve the control type, in this Bravis `ct_lists_pricing`.
     *
     * @since 1.0.0
     * @access public
     *

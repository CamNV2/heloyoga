 ...
 * @since 1.0.0
 */
class Bravis_Theme_Core_EmojiOneArea_Control extends \Elementor\Base_Data_Control {
    ...
    public function enqueue() {
        ...
        wp_register_script( 'emojionearea-control', CT_URL . 'assets/js/emojionearea-control.js', [ 'emojionearea', 'jquery' ], '1.0.0' );

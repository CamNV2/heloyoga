...
$custom_footer = wellco_get_page_opt('custom_footer', 'false');
$footer_layout_custom_page = wellco_get_page_opt('footer_layout_custom');
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        if (!is_wp_error($post) && $post->ID == $footer_layout_custom && class_exists('Bravis_Theme_Core') && function_exists('ct_print_html')){

    ...
    var WidgetCTCountDownHandler = function( $scope, $ ) {
        ...
        $('.ct-countdown').each(function () {
            ...
            setInterval(function () {
                ...
                _this.html(''
                    + '<div class="countdown-item"><div class="countdown-item-inner"><div class="countdown-amount">' + days + '</div><div class="countdown-period">' + text_day + '</div></div><div class="space-dots"></div></div>'
                    + '<div class="countdown-item"><div class="countdown-item-inner"><div class="countdown-amount">' + hours + '</div><div class="countdown-period">' + text_hour + '</div></div><div class="space-dots"></div></div>'
                    + '<div class="countdown-item"><div class="countdown-item-inner"><div class="countdown-amount">' + minutes + '</div><div class="countdown-period">' + text_minu + '</div></div><div class="space-dots"></div></div>'

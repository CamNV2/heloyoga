...
<?php if(isset($content_list) && !empty($content_list) && count($content_list)): ?>
	<div class="ct-particle-animate el-move-parents <?php echo esc_attr($settings['particle_inner_section']); ?>">
		<?php foreach ($content_list as $key => $value): 
		    ...
		    <div id="<?php echo esc_attr($html_id.$key); ?>" class="<?php echo esc_attr($value['type_position']); ?> <?php echo esc_attr($value['particle_animate']); ?>" <?php if($value['particle_animate'] == 'shape-parallax') { ?>data-speed="<?php echo esc_attr($parallax_speed); ?>" data-move="<?php echo esc_attr($parallax_move); ?>"<?php } ?>>
			    ...
			    <?php endif; ?>
			    <?php if(!empty($value['img_max_height']['size'])) : ?>
			    	<div class="ct-inline-css"  data-css="
			            .ct-particle-animate #<?php echo esc_attr($html_id.$key) ?> img {
			                max-height: <?php echo esc_attr($value['img_max_height']['size']).esc_attr($value['img_max_height']['unit']); ?>;

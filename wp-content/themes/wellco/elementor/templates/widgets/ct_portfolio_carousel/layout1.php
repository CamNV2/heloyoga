...
$widget->add_render_attribute( 'carousel', [
    'class' => 'ct-slick-carousel slick-shadow ct-arrow-middle',
    'data-arrows' => $arrows,
    'data-dots' => $dots,
...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-portfolio ct-portfolio-carousel1 ct-slick-slider">
    <div <?php ct_print_html($widget->get_render_attribute_string( 'inner' )); ?>>
        <div <?php ct_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
        <?php
            $default_size = '420x420'; 
            if(!empty($img_size)) {

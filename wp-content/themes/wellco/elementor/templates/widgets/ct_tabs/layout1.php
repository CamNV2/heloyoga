...
<div class="ct-tabs ct-tabs1 <?php echo esc_attr($settings['ct_animate']); ?> content-type-<?php echo esc_attr($tab['content_type']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    <?php if(!empty($wg_title)) : ?>
        <div class="ct-tabs--title">
            <div class="ct-heading item-st-hexagon">
                ...
                <h4 class="item--title">
                    <span><?php echo esc_attr($wg_title); ?></span>
                </h4>
            </div>
        </div>
    <?php endif; ?>
    <div class="ct-tabs--main">
        <div class="ct-tabs-title">
            <?php foreach ($tabs as $key => $tab) : 
                ...
                ?>
                <span class="ct-tab-title btn <?php if($active_tab == $key + 1) { echo 'active'; } ?>" data-target="#<?php echo esc_attr($html_id.'-'.$tab['_id']); ?>">
                    <?php
                        if($is_new):
                    ...
                    <i class="bravisicon-angle-arrow-right space-left"></i>    
                </span>
            <?php endforeach; ?>
        </div>

...
?>
<div class="ct-counter ct-counter-layout1 <?php echo esc_attr($settings['style_l1'].' '.$settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">

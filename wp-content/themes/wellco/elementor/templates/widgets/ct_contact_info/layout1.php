...
<?php if(isset($settings['contact_info']) && !empty($settings['contact_info']) && count($settings['contact_info'])): ?>
    ...
    <ul id="<?php echo esc_attr($html_id); ?>" class="ct-contact-info ct-contact-info1 list-<?php echo esc_attr($settings['list_type']); ?> <?php echo esc_attr($ct_animate); ?>" data-wow-duration="1.2s">
        <?php

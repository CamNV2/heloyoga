...
?>
<div class="ct-fancy-box ct-fancy-box-layout5 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    <div class="item--inner bg-image">
        ...
        <div class="item--meta">
            ...
            <?php if ( ! empty( $settings['btn_text'] ) ) { ?>
                <a class="btn-text-effect1" <?php ct_print_html($widget->get_render_attribute_string( 'button' )); ?>>

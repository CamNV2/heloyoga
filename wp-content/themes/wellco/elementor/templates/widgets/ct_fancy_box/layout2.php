...
?>
<div class="ct-fancy-box ct-fancy-box-layout2 <?php echo esc_attr($settings['style_l2'].' '.$settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">

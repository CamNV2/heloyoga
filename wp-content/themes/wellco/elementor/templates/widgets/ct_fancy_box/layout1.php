...
?>
<div class="ct-fancy-box ct-fancy-box-layout1 <?php echo esc_attr($settings['style_l1'].' '.$settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    <div class="item--inner">
        ...
        <div class="item--meta">
            ...
            <?php if ( ! empty( $settings['btn_text'] ) ) { ?>
                <div class="item--link">
                    <a class="btn btn-animate btn-boxshadow" <?php ct_print_html($widget->get_render_attribute_string( 'button' )); ?>><?php echo esc_attr($settings['btn_text']); ?><i class="bravisicon-angle-arrow-right space-left"></i></a>
                </div>
            <?php } ?>
        </div>
        <?php if($settings['style_l1'] == 'style2') : ?>
            <div class="item--number"><?php echo esc_attr($settings['item_number']); ?></div>
        <?php endif; ?>
    </div>
</div>
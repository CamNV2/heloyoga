...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="ct-testimonial ct-testimonial-carousel3 ct-slick-slider" <?php if($drap) : ?>data-cursor-drap="DRAG"<?php endif; ?>>

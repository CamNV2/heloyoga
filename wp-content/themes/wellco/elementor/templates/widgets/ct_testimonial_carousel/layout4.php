...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="ct-testimonial ct-testimonial-carousel4 ct-slick-slider" <?php if($drap) : ?>data-cursor-drap="DRAG"<?php endif; ?>>
                            ...
                            <div class="item--inner <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-duration="1.2s">
                                <div class="item--content">
                                    <div class="item--content-inner">
                                        <div class="item--icon-abs"><i class="flaticon flaticon-quote"></i></div>
                                        <div class="item--description"><?php echo ct_print_html($description); ?></div>
                                        <div class="item--holder">
                                            <div class="item--icon"><i class="flaticon flaticon-quote"></i></div>
                                            <div class="item--meta">
                                                <h4 class="item--title">    
                                ...
                                <?php if(!empty($image['id'])) { 
                                    ...
                                    ?>
                                    <div class="item--image bg-image" style="background-image: url(<?php echo esc_url($thumbnail_url); ?>);">
                                        <div class="item--star">

            ...
            <div <?php ct_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <?php foreach ($team as $key => $value):
                    ...
                    <div class="carousel-item">
                        <div class="item--inner bg-image <?php echo esc_attr($ct_animate); ?>" data-wow-duration="1.2s">
                            <?php if(!empty($image)) { ?>
                                <div class="item--image">
                                    <?php echo wp_kses_post($thumbnail); ?>
                                    <?php if ( ! empty( $link['url'] ) ) { ?><a <?php echo implode( ' ', [ $link_attributes ] ); ?>><i class="bravisicon-close"></i></a><?php } ?>
                                </div>
                            <?php } ?>

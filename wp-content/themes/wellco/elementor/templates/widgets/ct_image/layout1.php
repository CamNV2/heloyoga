...
?>
<div data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms" class="ct-image-single <?php if($img_parallax == 'yes') : ?>ct-block-parallax<?php endif; ?> <?php if($img_tilt == 'yes') { echo 'img-hover-scale'; } ?> <?php echo esc_attr($ct_animate); ?>" data-width="<?php echo esc_attr($img_parallax_w); ?>" data-height="<?php echo esc_attr($img_parallax_h); ?>" data-maxtilt="4" data-speedtilt="400" data-perspectivetilt="1000">

...
ct_add_custom_widget(
    array(
        'name' => 'ct_link',
        'title' => esc_html__('Bravis Links', 'wellco'),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Line Space Color', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .ct-link1 a:before' => 'background-color: {{VALUE}};',
                            ],
                        ),
                        array(
                        ...
                        array(
                            'name' => 'item_space',
                            'label' => esc_html__('Item Spacer', 'wellco' ),

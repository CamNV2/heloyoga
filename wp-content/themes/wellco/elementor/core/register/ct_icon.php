...
ct_add_custom_widget(
    array(
        'name' => 'ct_icon',
        'title' => esc_html__('Bravis Icons', 'wellco'),
        'icon' => 'eicon-alert',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Icon Color Hover', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'default' => '',
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Icon Typography', 'wellco' ),
                        ...
                        array(
                            'name' => 'icon_space',
                            'label' => esc_html__('Icon Spacer', 'wellco' ),

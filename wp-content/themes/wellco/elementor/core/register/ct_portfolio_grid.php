...
ct_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Bravis Portfolio Grid', 'wellco' ),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'filter',
                            'label' => esc_html__('Filter on Masonry', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'false',
                            'options' => [
                                'true' => esc_html__('Enable', 'wellco' ),
                                'false' => esc_html__('Disable', 'wellco' ),
                            ],
                        ),
                        array(
                            'name' => 'filter_default_title',
                            'label' => esc_html__('Filter Default Title', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'default' => esc_html__('All', 'wellco' ),
                            'condition' => [
                                'filter' => 'true',
                            ],
                        ),
                        array(
                            ...
                            'label' => esc_html__('Pagination Type', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'false',
                            'options' => [
                                'pagination' => esc_html__('Pagination', 'wellco' ),
                                'loadmore' => esc_html__('Loadmore', 'wellco' ),
                                'false' => esc_html__('Disable', 'wellco' ),
                            ],
                        ),
                        array(
                            'name' => 'loadmore_style',
                            'label' => esc_html__('Button Loadmore Style', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'style1',
                            'options' => [
                        ...
                        array(
                            ...
                            'options' => [
                                'default-space' => esc_html__('Default', 'wellco' ),
                                'no-space' => esc_html__('No Space', 'wellco' ),
                            ],
                        ),
                        array(
                            'name' => 'col_xs',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'show_title',
                            'label' => esc_html__('Show Title', 'wellco' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'category_color',
                            'label' => esc_html__('Category Color', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Category Typography', 'wellco' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',

...
ct_add_custom_widget(
    array(
        'name' => 'ct_heading',
        'title' => esc_html__('Bravis Heading', 'wellco' ),
        'icon' => 'eicon-heading',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'h_width',
                            'label' => esc_html__('Max Width', 'wellco' ),
                        ...
                        array(
                            'name' => 'title_tag',
                            'label' => esc_html__('Heading HTML Tag', 'wellco' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Bottom Spacer', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'default' => [
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Sub Title Color', 'wellco' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Sub Title Typography', 'wellco' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',

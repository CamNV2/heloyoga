...
add_action('wp_enqueue_scripts',  'wellco_elementor_enqueue_scripts' );
add_filter('single_template',  'wellco_load_canvas_template' );

function wellco_elementor_enqueue_scripts() {
    // not active pxl theme
    $footer_layout_custom = wellco_get_opt('footer_layout_custom');
    $footer_page_layout_custom = wellco_get_page_opt('footer_layout_custom','');
...
function wellco_load_canvas_template($single_template) {
    global $post;

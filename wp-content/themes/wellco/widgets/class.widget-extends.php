...
class Wellco_Widget_Extends
{
    ...
    function extend_widget_form( $widget, $return, $instance )
    {
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-use_theme_style"><?php esc_html_e( 'Use Theme Style', 'wellco' ); ?></label>
        </p>
        <?php
        }
        ...
        ?>
        <p>
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-el_class"><?php esc_html_e( 'CSS Class', 'wellco' ); ?></label>
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-hide_title"><?php esc_html_e( 'Hide widget title', 'wellco' ); ?></label>
        </p>
        <?php

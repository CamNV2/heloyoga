...
class GetInTouch_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'getintouch_widget',
            esc_html__('* Get In Touch', 'wellco'),
            array('description' => esc_html__('Get In Touch Widget', 'wellco'),)
        );
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('address_label')); ?>"><?php esc_html_e( 'Address Label', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('address_text')); ?>"><?php esc_html_e( 'Address', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('phone_label')); ?>"><?php esc_html_e( 'Phone Label', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('phone_text')); ?>"><?php esc_html_e( 'Phone', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('time_label')); ?>"><?php esc_html_e( 'Time Label', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('time_text')); ?>"><?php esc_html_e( 'Time', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('btn_text')); ?>"><?php esc_html_e( 'Button Text', 'wellco' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('btn_link')); ?>"><?php esc_html_e( 'Button Link', 'wellco' ); ?></label>
